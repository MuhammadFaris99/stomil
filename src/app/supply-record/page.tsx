  ...
  return (
    <section className="lg:py-24 py-16">
      <div className="container" data-aos="fade-up">
        ...
        {/* supplyRecord.list.map(info => ()) key={info.title} */}
        {products.map((item, key) => (
          <div className="bg-gray-100 p-8 mb-6" key={item.title}>
            <div>
              ...
              {/* supplyRecord.list.map(info => ()) key={info.description} */}
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-6 mt-16">
              <div className="relative overflow-x-auto">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  {/* supplyRecord.list.map(info => ()) key={info.table} */}
              ...
              {/* supplyRecord.list.map(info => ()) key={info.image} */}
