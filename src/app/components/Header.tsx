            ...
            <div className="container">
                <div className="flex items-center justify-between">
                    <a className="navbar-brand" href="index_1.html">
                        <img src={navIcon1} className="mr-2 w-[130px]" alt="logo" />
                    </a>
                    ...
                    <div className="navbar-collapse flex-1 mobile-menu hidden min-[991px]:block" id="navbarNav">
                        <ul className="navbar-nav justify-end horizontal-menu">
                            <li className="scroll dropdown active group/menu">
                                <a href="javaScript:void();" className="dropdown-toggle"><span>Home</span></a>
                            </li>
                            <li className="scroll dropdown group/menu">
                                <a href="javaScript:void();" className="dropdown-toggle"><span>About Us</span></a>
                            </li> 
                            <li className="scroll dropdown group/menu">
                                <a href="javaScript:void();" className="dropdown-toggle"><span>Products</span></a>
                                <ul className="dropdown-menu hidden group-hover/menu:block">
                                    {products.products.map((item, i) => (
                                        <li key={i}> <a href={item.href}> {item.title} Product</a></li>
                                    ))}
                                </ul>
                            </li>                           
                            <li className="scroll dropdown group/menu">
                            ...
                            <li className="scroll dropdown group/menu">
                                <a href="javaScript:void();" className="dropdown-toggle"><span>Career</span></a>
                            </li>
                            <li className="scroll dropdown group/menu">
                                <a href="javaScript:void();" className="dropdown-toggle"><span>Contact Us</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
