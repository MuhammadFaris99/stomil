...
const Header = () => {
  ...
  return (
    <nav className="navbar fixed right-0 left-0 top-0 transition-all duration-500 ease shadow-lg shadow-gray-200/20 bg-white border-gray-200 dark:bg-neutral-800 z-40 dark:shadow-neutral-900 max-w-screen-2xl mx-auto" id="navbar">
      <div className="mx-auto container">
        <div className="flex flex-wrap items-center justify-between mx-auto">
          ...
          <div id="navbar-collapse" className={`navbar-res items-center justify-between w-full text-sm lg:flex lg:w-auto lg:order-1 group-focus:[.navbar-toggler]:block ${isOpen ? '' : 'hidden'}`}>
            <ul className="flex flex-col items-start mt-5 mb-10 font-medium lg:mt-0 lg:mb-0 lg:items-center lg:flex-row" id="navigation-menu">
              <li className="relative dropdown py-5 lg:py-0">
                <Link href="/" className="text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]" id="home" data-bs-toggle="dropdown">Home <i className='align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1'></i></Link>
              </li>
              <li className="relative dropdown py-5 lg:py-0">
                <Link href="/about-us" className="text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]" id="about-us" data-bs-toggle="dropdown">About Us <i className='align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1'></i></Link>
              </li>

              <li className="relative dropdown py-5 lg:py-0">
                <button className="text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]" id="blog" data-bs-toggle="dropdown">Products <i className='align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1'></i></button>
              ...
              <li className="relative dropdown py-5 lg:py-0">
                <button className="text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]" id="blog" data-bs-toggle="dropdown">Services <i className='align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1'></i></button>
                <ul className="relative top-auto z-50 py-2 list-none bg-white border-0 rounded dropdown-menu lg:border border-gray-500/20 lg:absolute ltr:-left-3 rtl:-right-3  lg:shadow-lg dark:bg-neutral-800" aria-labelledby="product">
              ...
              <li className="relative dropdown py-5 lg:py-0">
                <Link href="/supply-record" className="py-5 text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]" id="supplyrecord" data-bs-toggle="dropdown">Supply Record <i className='align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1'></i></Link>
              </li>
              <li className="relative dropdown py-5 lg:py-0">
