...
function Header() {
  ...
  return (
    <nav
      className="navbar fixed right-0 left-0 top-0 transition-all duration-500 ease shadow-lg shadow-gray-200/20 bg-white border-gray-200 dark:bg-neutral-800 z-40 dark:shadow-neutral-900 max-w-screen-2xl mx-auto"
      id="navbar"
    >
      <div className="mx-auto container">
        <div className="flex flex-wrap items-center justify-between mx-auto">
          ...
          >
            <ul
              className="flex flex-col items-start mt-5 mb-10 font-medium lg:mt-0 lg:mb-0 lg:items-center lg:flex-row"
              id="navigation-menu"
            >
              <li className="relative dropdown py-5 lg:py-0">
                <Link
                  href="/"
                  className="text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]"
                  id="home"
              ...
              <li className="relative dropdown py-5 lg:py-0">
                <Link
                  href="/supply-record"
                  className="py-5 text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]"
                  id="supplyrecord"
                  data-bs-toggle="dropdown"
                >
