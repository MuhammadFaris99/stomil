...
const Header = () => {
  ...
  return (
    <nav className="navbar fixed right-0 left-0 top-0 px-5  transition-all duration-500 ease shadow-lg shadow-gray-200/20 bg-white border-gray-200 dark:bg-neutral-800 z-40 dark:shadow-neutral-900 max-w-screen-2xl mx-auto" id="navbar">
